...
-- NOTE: we can place these in any file, the decision of creating
...
function init__di_ampliLevel()
    ...
    MainWindow.di_ampliLevel:setValue(0)
    MainWindow.di_signalEcho:setValue(0)
    MainWindow.di_nrLevel:setValue(0)
    MainWindow.di_volumeLevel:setValue(0)
end
...
function click__clearButton()
    __log("Manual Log: clic__clearButton")
    -- We can perform an action on widgets placed in differents dialogs and windows
    MainWindow.spinBox:setValue(0)
end
